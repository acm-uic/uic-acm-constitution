...
\\
The Treasurer is primarily responsible for managing and accessing the Chicago Organization Fund (COF) account. Additionally, the COF account may be accessed by the President.
...
\\
Any member of the ACM who is a member of National ACM and provides proof to that effect shall be exempt from paying dues for the ACM. If at any time said National ACM membership should expire then the member must renew national membership within one week or else become a member in poor standing until either paying dues to the ACM or renewing membership with National ACM and producing proof of this renewal.\\
\\
The restrictions of subsection 3.1 shall not apply in cases where they conflict with the regulations of National ACM.
...
\\
The incoming President and Treasurer are responsible for submitting the required \emph{Annual Report} to National ACM.
