...
\\
Tasks can be added to and removed from the list by a Decision (section 6) made by the Officers. If a task has already been assigned, and if it is the only task assigned to that Secretary or SIG then the Task can only be removed by a plurality vote of a quorum of 50\% of the ACM Council.\\
\\
Any Tasks not assigned to a Secretary or SIG must be distributed amongst the Officers as they see fit.
...
\\
The ACM Council may veto any Decision made by the Officers. The veto can only be passed by a majority vote in a quorum composed of at least 50\% of the ACM Council. A veto passed in this way cannot be overridden or nullified by another Decision of the Officers; it can only be overridden by a vote of the Council as described above or by a vote of the Members as described in this section below in paragraph 5.\\
\\
...
\\
Tasks, see section 4.2.1, may be assigned to SIGs via a Decision of the ACM Council.
